    ...
    >
      ...
      <motion.div
        className={`max-w-4xl mx-auto ${
          darkMode ? "bg-gray-800 bg-opacity-50" : "bg-white bg-opacity-75"
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <motion.div variants={itemVariants}>
              <ContactItem
                icon={FaEnvelope}
                label="Email"
                value="unnatimoralwar@gmail.com"
                link="mailto:unnatimoralwar@gmail.com"
              />
              <ContactItem
                icon={FaLinkedin}
                label="LinkedIn"
                value="Unnati Moralwar"
                link="https://www.linkedin.com/in/unnati-moralwar-learner/"
              />
              <ContactItem
                icon={FaGithub}
                label="GitHub"
                value="unnatimoralwar"
                link="https://github.com/Unnati1610"
              />
              <ContactItem
                icon={FaMapMarkerAlt}
                label="Location"
          ...
          <motion.div
            className={`${
              darkMode ? "bg-indigo-400" : "bg-indigo-100"
            } rounded-lg p-6`}
            variants={itemVariants}
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() =>
                (window.location.href = "mailto:unnatimoralwar@gmail.com")
              }
            >
              Send a Message
            </motion.button>
